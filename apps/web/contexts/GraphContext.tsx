...
export function GraphProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (!messages.length || !artifact) {
      return;
    }
    if (updateRenderedArtifactRequired || threadSwitched || isStreaming) {
      return;
    }
  ...
  }, [artifact, threadData.threadId, updateRenderedArtifactRequired, threadSwitched, isStreaming, debouncedAPIUpdate, messages.length]);
  ...
  }, [threadData.threadId, userData.user, threadData.createThreadLoading, threadData.getThread, threadData.setThreadId, switchSelectedThread]);
