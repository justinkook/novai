...
NovAI uses LangGraph to orchestrate multi-step agent workflows (graphs) such as Open Canvas, BG3 gameplay, reflection, and thread titles.
...
```json
{
  ...
  "graphs": {
    ...
    "bg3": "./apps/agents/src/bg3-adventure/index.ts:graph",
