...
- **Multi-Ruleset Support**: Extensible framework supporting D&D 5e and custom rulesets
...
<Steps>
  ...
  <Step title="Response Return">
    Returns structured response to the client
  </Step>
</Steps>
...
- Review the [API Reference](/api-reference/engine/game-request) 